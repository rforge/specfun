...
## T.1
pnbeta.appr2(0.868,  10, 20, ncp=150)# 0.937569774351
## T.2
pnbeta.appr2(0.644,  10,  5, ncp= 20)# 0.0497384
pnbeta.appr2(0.80,   30, 30, ncp=140)# 0.7816822

## more extreme cases
x <- c(0.9, 0.95, 0.96, 0.97, 0.99)
pnbeta.appr2(x, 10, 20, 1000)# 7.953858e-08 8.276896e-02 3.709090e-01 8.216320e-01 9.999989e-01
...
pnbeta.appr2(x, 10, 30, 5000)
pbeta       (x, 10, 30, 5000)

## really large lambda: now "traditional" pbeta() seems hopeless
x <- 1 - 2^(-5:-15)
px <- cbind(appr2 = pnbeta.appr2(x, 10, 30, 1e6, log.p=TRUE),
